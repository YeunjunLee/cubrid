...
typedef enum
{
  ...
  /* HNSW statistics. */
  PSTAT_HNSW_NUM_VISITED_NODE,
  PSTAT_HNSW_NUM_VISITED_NODE_L0,
  ...
  PSTAT_HNSW_NUM_COMPUTED_DISTANCES_IN_REVERSE_REFINES_L0,

  PSTAT_HNSW_NUM_PAGE_ACCESS,
  PSTAT_HNSW_NUM_PAGE_ACCESS_L0,

  PSTAT_HNSW_NUM_VECTOR_ACCESS,
  PSTAT_HNSW_NUM_VECTOR_ACCESS_L0,
  PSTAT_HNSW_NUM_VECTOR_CACHE_HIT,	// for future
  PSTAT_HNSW_NUM_VECTOR_CACHE_HIT_L0,	// for future
  PSTAT_HNSW_NUM_VECTOR_CACHE_MISS,	// for future
  PSTAT_HNSW_NUM_VECTOR_CACHE_MISS_L0,	// for future

  PSTAT_HNSW_NUM_ENTRYPOINT_UPDATES,

  PSTAT_HNSW_NUM_CANDIDATES_PUSH,
  PSTAT_HNSW_NUM_CANDIDATES_PUSH_L0,
  PSTAT_HNSW_NUM_CANDIDATES_POP,
  PSTAT_HNSW_NUM_CANDIDATES_POP_L0,
  PSTAT_HNSW_NUM_CANDIDATES_PRUNE,
  PSTAT_HNSW_NUM_CANDIDATES_PRUNE_L0,
  PSTAT_HNSW_NUM_NEIGHBORS_SCAN,
  PSTAT_HNSW_NUM_NEIGHBORS_SCAN_L0,

  PSTAT_HNSW_NUM_NEIGHBORS_CACHE_HIT,
  PSTAT_HNSW_NUM_NEIGHBORS_PAGE_FIX,
  PSTAT_HNSW_NUM_NEIGHBORS_CACHE_HIT_L0,
  PSTAT_HNSW_NUM_NEIGHBORS_PAGE_FIX_L0,
