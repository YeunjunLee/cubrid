...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_TIME_COMPUTED_DISTANCES_USEC_L0,
				  "Time_hnsw_computed_distances_usec_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_COMPUTED_DISTANCES_INT8, "Num_hnsw_computed_distances_int8"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_COMPUTED_DISTANCES_INT8_L0,
				  "Num_hnsw_computed_distances_int8_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_TIME_COMPUTED_DISTANCES_INT8_USEC,
				  "Time_hnsw_computed_distances_int8_usec"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_TIME_COMPUTED_DISTANCES_INT8_USEC_L0,
				  "Time_hnsw_computed_distances_int8_usec_l0"),
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_PREFILTER_PASSED_TO_FP32,
				  "Num_hnsw_prefilter_passed_to_fp32"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_PREFILTER_PASSED_TO_FP32_L0,
				  "Num_hnsw_prefilter_passed_to_fp32_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_PREFILTER_REJECTED, "Num_hnsw_prefilter_rejected"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_PREFILTER_REJECTED_L0,
				  "Num_hnsw_prefilter_rejected_l0"),
